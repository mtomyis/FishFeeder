...
public class DetailUmur76Activity extends AppCompatActivity {

    protected static String EXTRA_ID = "";
    public static final String TAG = DetailUmur76Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Feeder");
        setContentView(R.layout.activity_detail_umur76);


        tvpakan = findViewById(R.id.id_U6_jam1);
        btHapusU = findViewById(R.id.btn_hapusU6);
        btSimpanU = findViewById(R.id.btn_simpanU6);
        menuumur = findViewById(R.id.idmenuumur76);
        p_Tunggu = findViewById(R.id.idtungguumur76);
        mRequestQueue = Volley.newRequestQueue(DetailUmur76Activity.this);
...
//                            }
                            ...
                            if (kode.equals("6")){
                                ...
                                Toast.makeText(DetailUmur76Activity.this, "Anda belum menambah waktu tabur ", Toast.LENGTH_SHORT).show();
                                Toast.makeText(DetailUmur76Activity.this, "Silahkan cek halaman kontrol feeder ", Toast.LENGTH_SHORT).show();
                                btSimpanU.setVisibility(View.VISIBLE);
...
//                            menuumur.setVisibleXRangeMaximum(65f);
                            ...
                            Toast.makeText(DetailUmur76Activity.this, "Connection Failed ", Toast.LENGTH_SHORT).show();
                            //switch mati tom
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (berhasil.equals("1")){
                                Toast.makeText(DetailUmur76Activity.this, "Done ", Toast.LENGTH_SHORT).show();
                            }
//                            menuumur.setVisibleXRangeMaximum(65f);
                            p_Tunggu.setVisibility(View.GONE);
                            menuumur.setVisibility(View.VISIBLE);
