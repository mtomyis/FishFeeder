package com.tambakudang.tomtom.tambak.feeder.pengingat.tgl1;
...
public class NotifyService extends Service {
    ...
    private void showNotification() {
        ...
        Intent notifi = new Intent(this,DetailUmur1Activity.class);
        ...
        builder.setSmallIcon(R.drawable.ic_dialog_alert)
                .setContentTitle("Fish Feeder").setContentText("Waktunya Membuat Jadwal pakan")
