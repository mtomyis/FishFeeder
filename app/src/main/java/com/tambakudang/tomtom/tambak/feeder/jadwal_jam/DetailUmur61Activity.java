...
public class DetailUmur61Activity extends AppCompatActivity {

    protected static String EXTRA_ID = "";
    public static final String TAG = DetailUmur61Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_umur61);
        setTitle("Feeder");


        tvpakan = findViewById(R.id.id_U5_jam1);
        btHapusU = findViewById(R.id.btn_hapusU5);
        btSimpanU = findViewById(R.id.btn_simpanU5);
        menuumur = findViewById(R.id.idmenuumur61);
        p_Tunggu = findViewById(R.id.idtungguumur61);
        mRequestQueue = Volley.newRequestQueue(DetailUmur61Activity.this);
...
//                            }
                            ...
                            if (kode.equals("1")){
                                ...
                                Toast.makeText(DetailUmur61Activity.this, "Anda belum menambah waktu tabur ", Toast.LENGTH_SHORT).show();
                                Toast.makeText(DetailUmur61Activity.this, "Silahkan cek halaman kontrol feeder ", Toast.LENGTH_SHORT).show();
                                btSimpanU.setVisibility(View.VISIBLE);
...
//                            menuumur.setVisibleXRangeMaximum(65f);
                            ...
                            Toast.makeText(DetailUmur61Activity.this, "Connection Failed ", Toast.LENGTH_SHORT).show();
                            //switch mati tom
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (berhasil.equals("1")){
                                Toast.makeText(DetailUmur61Activity.this, "Waktu berhasil disimpan ", Toast.LENGTH_SHORT).show();
                            }
//                            menuumur.setVisibleXRangeMaximum(65f);
                            p_Tunggu.setVisibility(View.GONE);
                            menuumur.setVisibility(View.VISIBLE);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String berhasil = jsonObject.getString("success");
                            if (berhasil.equals("1")){
                                Toast.makeText(DetailUmur61Activity.this, "Waktu berhasil dihapus ", Toast.LENGTH_SHORT).show();
                            }
//                            menuumur.setVisibleXRangeMaximum(65f);
                            p_Tunggu.setVisibility(View.GONE);
                            menuumur.setVisibility(View.VISIBLE);
