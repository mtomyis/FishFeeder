...
public class DetailUmur16Activity extends AppCompatActivity {
    public static final String TAG = DetailUmur16Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_umur16);
        setTitle("Feeder");

        menuumur = findViewById(R.id.idmenuumur16);
        tvpakan = findViewById(R.id.id_U2_jam1);
        btHapusU = findViewById(R.id.btn_hapusU2);
        btSimpanU = findViewById(R.id.btn_simpanU2);
        p_Tunggu = findViewById(R.id.idtungguumur16);
        mRequestQueue = Volley.newRequestQueue(DetailUmur16Activity.this);
...
//                            }
                            ...
                            if (kode.equals("2")){
                                ...
                                Toast.makeText(DetailUmur16Activity.this, "Anda belum menambah waktu tabur ", Toast.LENGTH_SHORT).show();
                                Toast.makeText(DetailUmur16Activity.this, "Silahkan cek halaman kontrol feeder ", Toast.LENGTH_SHORT).show();
                                btSimpanU.setVisibility(View.VISIBLE);
...
//                            menuumur.setVisibleXRangeMaximum(65f);
                            ...
                            Toast.makeText(DetailUmur16Activity.this, "Connection Failed ", Toast.LENGTH_SHORT).show();
                            //switch mati tom
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (berhasil.equals("1")){
                                Toast.makeText(DetailUmur16Activity.this, "Waktu berhasil disimpan ", Toast.LENGTH_SHORT).show();
                            }
//                            menuumur.setVisibleXRangeMaximum(65f);
                            p_Tunggu.setVisibility(View.GONE);
                            menuumur.setVisibility(View.VISIBLE);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String berhasil = jsonObject.getString("success");
                            if (berhasil.equals("1")){
                                Toast.makeText(DetailUmur16Activity.this, "Waktu berhasil dihapus ", Toast.LENGTH_SHORT).show();
                            }
//                            menuumur.setVisibleXRangeMaximum(65f);
                            p_Tunggu.setVisibility(View.GONE);
                            menuumur.setVisibility(View.VISIBLE);
